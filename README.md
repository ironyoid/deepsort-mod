# DeepSORT Modification — HSE MS DL Course Final Project

Modernization of the original Deep SORT tracker with swappable detection and
re-identification models, evaluated on MOT Challenge sequences.

The original Deep SORT documentation follows.
